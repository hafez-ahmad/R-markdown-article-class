...
abstract: | 
I will write abstract after completing paper.
...
In this mini paper, the **objectives** are (a) to present results of an analysis of the land surface temperature and precipitation, (b) to quantify normalized vegetation index for three years and estimate the land use /land cover, (c) to determine the relationship  between vegetation and land use.
# Methods
...
legend('bottomright',legend= sampl$Classname,fill=c('blue','green','darkkhaki','antiquewhite4','red'),bty='n',bg='transparent')
