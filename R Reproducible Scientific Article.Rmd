...
###we can use citation add symbol @Mukhopadhyay2018 ##\# git ###initiate the upstream tracking of the project on the GitHub repo git remote add origin <https://github.com/hafez-ahmad/R-markdown-article-class.git>
...
### Radio metric calibration and Atmospheric Correction
...
## landsaurfare temperature and precipitation
