...
classify_raster<- function(trainshp, rasterfile){
  ...
  levels(lulc)<- df
  calculated_Area<-as.data.frame(zonal(area(classified),classified2020[[1]],'sum'))
...
classified2020<-classify_raster('data/raster_vector/training_sample.shp',data2020_06)
