...
ndvi2020_2<- ggplot(data = as.data.frame(chm_classified ,xy=TRUE)) +
  ...
  scale_fill_manual(name = "NDVI",
                    ...
                    labels = c('No data','No vegetation','Baresoil','Good'),
                    na.translate = FALSE) +
  ...
  # spatial-aware automatic scale bar
  annotation_scale(location = "tl") +
  # spatial-aware automatic north arrow
  annotation_north_arrow(location = "br", which_north = "true")
# subplots
ndviplot<-ggarrange(ndvi2020_2, ndvi2020_2, ndvi2020_2,ndvi2020_2,nrow = 2,ncol=2,labels = c("a","b","c","d"),label.x=0.9,common.legend = TRUE)
# save it
ggsave("Figures_or_Maps/ndvi_2020_06.png",plot=ndviplot,device="png",dpi=500)
```
```{r echo=FALSE}
ndvi_plot<-function(raster_data){
  ...
  ndviclassified <- reclassify(ndvi_datast_rprj,
                     reclass)
  ndvi_r_plot<- ggplot(data = as.data.frame(ndviclassified ,xy=TRUE)) +
  #geom_raster(aes(x = x, y = y, fill = as.character(layer))) + 
  geom_tile(aes(x, y, fill=as.character(layer)))+
  scale_fill_manual(name = "NDVI",
                    values = c('black','red','grey','green'),
...
ndvi1<-ndvi_plot('data/raster_vector/LC08_L1TP_022037_20200612_20200823_02_T1.tif')
ndvi2<-ndvi_plot('data/raster_vector/LC08_L1TP_022037_20210223_20210303_02_T1.tif')
ndvi3<-ndvi_plot('data/raster_vector/LC08_L1TP_022037_20210615_20210622_02_T1.tif')
ndvi4<-ndvi_plot('data/raster_vector/LC08_L1TP_022037_20220314_20220322_02_T1.tif')


ndviplot<-ggarrange(ndvi1,ndvi2,ndvi3,ndvi4,nrow = 2,ncol=2,labels = c("a","b","c","d"),label.x=0.9,common.legend = TRUE)
# save it
ggsave("Figures_or_Maps/ndvi_2020_06.png",plot=ndviplot,device="png",dpi=500)
