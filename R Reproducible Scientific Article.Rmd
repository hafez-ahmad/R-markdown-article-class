...
for the Landsat 8, the formula is given $NDVI=\frac{BAND 5 - Band 4}{Band 5 + Band 4}$

\$ Band 5-- reflection in the near-infrared spectrum\$ \$Band 4 -- reflection in the red range of the spectrum \$
...
# reading data
lst<- read_csv("data/land surface temperature2010_22.csv")
...
Monthly average temperature is `r printnum(tmp_mean)` [C] and standard deviation is `r printnum(tmp_sd)`
